var SwipeSlide = function(container, options){
  this.options = $.extend({
    ...
    tolerance:0.3,                // values between 0 and 1, where 1 means you have to drag to the center of the slide (a value of 1 equals the ios behaviour)
...
SwipeSlide.prototype = {
  ...
  move: function(distance, delay, callback) {
	...
	this.reel.animate(this.animationProperties(distance), { duration: 0, easing: this.options.easing, complete: callback })
  },
