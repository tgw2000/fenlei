            ...
            <div class="user_main cc">
                ...
                <div class="Tab_head">
                    <ul>
                        ...
                        <li class="on"><a href="<?php echo site_url("user/usercard/")?>">身份证认证</a></li>
                        <li><a href="<?php echo site_url("user/userlicense/")?>">营业执照认证</a></li>
                    </ul>
                </div>
                <div class="blank20"></div>
                <form id="usercard_form">
                    <table class="tb">
                        <tr>
                            <td style="padding-bottom: 0;">上传身份证：</td>
                            <td style="padding-bottom: 0;"><div id="upusercard"></div></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="uploadimgs" type="hidden" value="<?php echo $usercard ?>" name="uploadimgs"/>
