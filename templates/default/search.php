    ...
    <body>
        ...
        <div class="wapper mt10">
            ...
            <div class="bor cc mt5">
                <div class="type_list_top f14">找到“<font class="fred fw"><?php echo $keyword?></font>”相关信息共<font class="fred fw"><?php echo $total?></font>条</div>
                <div class="blank5"></div>
                <div class="f14 cc">
                    <?php if($all_type){?>
                    <dl class="all_type cc">
                        <dt>全站</dt>
                        <dd>
                            <ul class="all_type_ul">
                                <?php foreach($all_type as $row){
                                    if($cid ==$row['cid']){
                                ?>
                                    <li><span class="fred fw"><?php echo $row['type']?></span><em><?php echo $row['count']?></em></li>
                                <?php }else{?>
                                    <li><a href="<?php echo site_url("search/$row[pinyin]/?keyword=$keyword")?>"><?php echo $row['type']?></a><em><?php echo $row['count']?></em></li>
                                <?php }}?>
                            </ul>
                            <span class="icon morebtn">展开</span>
                        </dd>
                    </dl>
                        ...
                        <dd>
                            <ul>
                                ...
                                ?>
                                    ...
                                    <?php }else{ 
                                        $url = url_par("$field=$k&keyword=$keyword");    
                                    ?>                                                                                            
                ...
                <form id="headsearch" method="get">
                    <input type="hidden" name="pinyin" value="<?php echo $pinyin?>" />
            ...
            <p class="text_center f14">共 <span class="fw red"><?php echo $total?></span> 条信息，<a href="<?php echo site_url("post/$current_cat[pinyin]/")?>">马上发一条<?php echo $current_cat['title']?>信息</a></p>
